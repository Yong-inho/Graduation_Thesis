...
#ifndef OCALL_UPLOADBUCKET_DEFINED__
#define OCALL_UPLOADBUCKET_DEFINED__
uint8_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_uploadBucket, (unsigned char* serialized_bucket, uint32_t bucket_size, uint32_t label, unsigned char* hash, uint32_t hash_size, uint32_t size_for_level, uint8_t recursion_level));
#endif
#ifndef OCALL_DOWNLOADBUCKET_DEFINED__
#define OCALL_DOWNLOADBUCKET_DEFINED__
uint8_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_downloadBucket, (unsigned char* serialized_bucket, uint32_t bucket_size, uint32_t label, unsigned char* hash, uint32_t hash_size, uint32_t size_for_level, uint8_t level));
#endif
#ifndef OCALL_DOWNLOADPATH_DEFINED__
#define OCALL_DOWNLOADPATH_DEFINED__
uint8_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_downloadPath, (unsigned char* serialized_path, uint32_t path_size, uint32_t label, unsigned char* path_hash, uint32_t path_hash_size, uint8_t level, uint32_t D_lev));
#endif
#ifndef OCALL_UPLOADPATH_DEFINED__
#define OCALL_UPLOADPATH_DEFINED__
uint8_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_uploadPath, (unsigned char* serialized_path, uint32_t path_size, uint32_t label, unsigned char* path_hash, uint32_t path_hash_size, uint8_t level, uint32_t D_level));
#endif
#ifndef OCALL_BUILDFETCHCHILDHASH_DEFINED__
#define OCALL_BUILDFETCHCHILDHASH_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_buildFetchChildHash, (uint32_t left, uint32_t right, unsigned char* lchild, unsigned char* rchild, uint32_t hash_size, uint32_t recursion_level));
#endif
