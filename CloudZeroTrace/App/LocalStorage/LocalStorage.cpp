...
#ifdef OC_DEBUG
    printf("\t\t[Untrusted/LocalStorage] Saving new path\n");
#endif
...
#ifdef OC_DEBUG
    printf("\t\t[Untrusted/LocalStorage] Sending path\n");
    //printf("Downloaded Path: ");
    //showPath_reverse(path, Z, p_D, size_for_level-24);
#endif
